...
/**
 * AbstractProUseId entity provides the base persistence definition of the
 * ProUseId entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractProUseId implements java.io.Serializable {
	...
	/** default constructor */
	public AbstractProUseId() {
	}

	/** full constructor */
	public AbstractProUseId(User user, Project project) {
		this.user = user;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AbstractProUseId))
			return false;
		AbstractProUseId castOther = (AbstractProUseId) other;
