...
public class NoteDetailsDAO {
	...
	public NoteDetails findById(java.lang.Integer id) {
		...
		try {
			NoteDetails instance = (NoteDetails) getCurrentSession().get(
	...
	public List<NoteDetails> findByExample(NoteDetails instance) {
		log.debug("finding NoteDetails instance by example");
		try {
			List<NoteDetails> results = (List<NoteDetails>) getCurrentSession()
	...
	public List<NoteDetails> findByType(Object type) {
		return findByProperty(TYPE, type);
	}

	public List<NoteDetails> findByText(Object text) {
		return findByProperty(TEXT, text);
	}

	public List<NoteDetails> findByPath(Object path) {
		return findByProperty(PATH, path);
	}

	public List<NoteDetails> findByState(Object state) {
	...
	public NoteDetails merge(NoteDetails detachedInstance) {
		...
		try {
			NoteDetails result = (NoteDetails) getCurrentSession().merge(
					detachedInstance);
	...
	public static NoteDetailsDAO getFromApplicationContext(
			ApplicationContext ctx) {
		return (NoteDetailsDAO) ctx.getBean("NoteDetailsDAO");
	}
}